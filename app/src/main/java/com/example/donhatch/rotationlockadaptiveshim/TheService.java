    ...
    public void onCreate() {
        ...
        mOrientationEventListener = new android.view.OrientationEventListener(this, android.hardware.SensorManager.SENSOR_DELAY_NORMAL) {
            ...
            public void onOrientationChanged(int degrees) {
                ...
                if (degrees == android.view.OrientationEventListener.ORIENTATION_UNKNOWN) {
                    ...
                    if (mDegrees == -1) {
                        ...
                        if (mVerboseLevel == 1) System.out.println("        in onOrientationChanged(degrees="+degrees+")");
                        if (mVerboseLevel >= 1) System.out.println("          initial mClosestCompassPoint = " + mClosestCompassPoint);
                        if (mVerboseLevel == 1) System.out.println("        out onOrientationChanged(degrees="+degrees+")");
                        mDegrees = degrees;
                    } else {
                        int distanceFromClosestCompassPoint = Math.abs(degrees - mClosestCompassPoint);
                        if (distanceFromClosestCompassPoint > 180)
